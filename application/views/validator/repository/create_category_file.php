  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <br>
        <div class="box">
            <div class="box-body">
              <form id="create_category" action="<?php echo base_url()?>validator/repository/create_category_file/do" method="post">
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nama Kategori</label>
                    <input type="text" class="form-control" placeholder="Masukkan Nama Kategori File" name="category_name" title="Masukkan Nama Kategori File" required>
                  </div>
