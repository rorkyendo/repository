  ...
  <section class="content">
    ...
    <br>
      <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <?php foreach ($file_category as $key): ?>
            <form id="edit_category_file" action="<?php echo base_url()?>validator/repository/edit_category_file/do_edit/<?php echo $key->id_file_category?>" method="post">
            <div class="col-md-6">
                <div class="form-group">
                  <label>Nama Kategori</label>
                  <input type="text" class="form-control" name="nama_file_category" placeholder="Masukkan Nama Kategori" value="<?php echo $key->nama_file_category?>" title="Masukkan Nama Kategori File" required>
                </div>
      ...
      $("form#edit_category_file").validate({
        lang: 'id',
      });
      </script>
