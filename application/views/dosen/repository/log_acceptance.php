    ...
    <section class="content-header">
     <img src="<?php echo base_url()?>assets/img/logon.png" class="img-responsive" style="width:25px" alt="USU">
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>dosen/repository/log_acceptance">List Repository Menunggu Persetujuan</a></li>
      </ol>
    </section>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Jurnal</td>
                      <td>03-12-2018</td>
                      <td><button class="btn btn-info btn-rounded btn-sm">Menunggu Persetujuan</button></td>
                      <td>
