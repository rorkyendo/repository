  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <img src="<?php echo base_url()?>assets/img/logon.png" class="img-responsive" style="width:25px" alt="USU">
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>mahasiswa/repository/edit">Edit Repository</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <br>
        <div class="box">
            <div class="box-body">
              <form id="create_repository" action="<?php echo base_url()?>mahasiswa/repository/edit/do_edit/<?php echo $id_repository?>" method="post" enctype="multipart/form-data">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Cover Image</label>
                  <img src="<?php echo base_url().$key->repository_cover_image?>" class="img-responsive" alt="gambar" id='gbr'>
                ...
                <script type="text/javascript">
                  ...
                  <div class="form-group">
                    <label>Lihat File Lama :</label><span><a href='<?php echo base_url().$key->repository_location?>'>File lama</a></span><br><br>
          ...
          <div id="addCategory" class="modal fade" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <form action="<?php echo base_url()?>mahasiswa/repository/create_category/<?php echo $id_repository?>" method="post">
