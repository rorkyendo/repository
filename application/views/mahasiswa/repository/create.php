    ...
    <section class="content-header">
     <img src="<?php echo base_url()?>assets/img/logon.png" class="img-responsive" style="width:25px" alt="USU">
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>mahasiswa/repository/create">Buat Repository</a></li>
      </ol>
    </section>

    <section class="content">
      <a class="btn btn-sm btn-warning" href="<?php echo base_url()?>mahasiswa/repository"><i class="fa fa-angle-left"></i> Kembali ke repository</a>
      <br>
      <br>
        <div class="box">
            <div class="box-body">
              <form id="create_repository" action="<?php echo base_url()?>mahasiswa/repository/create/do" method="post" enctype="multipart/form-data">
              <div class="col-md-6">
