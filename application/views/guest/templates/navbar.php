	<header class="main-header">
        ...
        <a href="<?php echo base_url();?>guest/dashboard" class="logo">
		           ...
		           <li class="dropdown user user-menu">
		             ...
		             <ul class="dropdown-menu">
		               ...
		               <li class="user-footer">
		                 <div class="pull-left">
		                   <a href="<?php echo base_url() ?>guest/user/profile/<?php echo $this->session->userdata('user_id')?>" class="btn btn-default btn-flat">Profile</a>
		                 </div>
