    ...
    <section class="content-header">
     <img src="<?php echo base_url()?>assets/img/logon.png" class="img-responsive" style="width:25px" alt="USU">
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>admin/departemen/create">Tambah Departemen</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <br>
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" id="create_departemen" action="<?php echo base_url()?>admin/departemen/create/do" method="post">
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nama Departemen</label>
                    <input type="text" class="form-control" name="nama_departemen" placeholder="Masukkan Nama Departemen" title="Masukkan Nama Departemen" required>
                  </div>
...
$("form#create_departemen").validate({
  lang: 'id',
});
</script>
