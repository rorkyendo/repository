    ...
    <section class="content-header">
     <img src="<?php echo base_url()?>assets/img/logon.png" class="img-responsive" style="width:25px" alt="USU">
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>admin/repository/all">List Repository</a></li>
      </ol>
    </section>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="20%"><a target="_parent" href="<?php echo base_url()?>admin/repository/detail/<?php echo $key->id_repository?>"><?php echo $key->title?></a></td>
