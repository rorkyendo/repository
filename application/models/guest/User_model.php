...
class User_model extends CI_Model
{
  ...
  function get_profile($user_id,$kon_id)
  {
    return $this->db->query("SELECT * FROM users u, data_member dm where u.user_id = '$user_id' and u.group_id=5 and u.kon_id='$kon_id' and u.kon_id=dm.id_member")->result();
  }
